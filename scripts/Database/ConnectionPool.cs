...
public class ConnectionPool{
    ...
    private static System.Object objlock = typeof(ConnectionPool);//池管理对象实例
    private int size = 100;//池中连接数
    ...
    {
        //数据库连接字符串
        ConnectionStr = "server=localhost;User ID=root;Password=root;database=graduate;";
        //创建可用连接的集合
        pool = new ArrayList();
    }
